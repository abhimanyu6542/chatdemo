...
function App() {
  return (
    <div className="App">
      <div className="flex flex-wrap text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 ">
        {/* <Navbar /> */}
          ...
          <ul class="space-y-2">
            ...
            <li>
              ...
              >
                ...
                <span class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium bg-blue-100 text-blue-800 rounded-full dark:bg-blue-900 dark:text-blue-300">
                  3
                </span>
              </a>
            </li>
